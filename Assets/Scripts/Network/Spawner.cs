...
namespace Metaverse.Networking
{
        ...
        public void OnPlayerJoined (NetworkRunner runner, PlayerRef player)
        {
            if (runner.IsServer) {
                ...
                if (mapTokenIDWithNetworkPlayer.TryGetValue (playerToken, out NetworkPlayer networkPlayer)) {
                    ...
                    var spawnPoint = Utils.GetRandomSpawnPoint ();
                    NetworkPlayer spawnedNetworkPlayer = runner.Spawn (playerPrefab, spawnPoint.position, spawnPoint.rotation, player);
